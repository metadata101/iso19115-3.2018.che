...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:diagnostics>
    ...
    <sch:diagnostic id="rule.che.aap-metadatamaintenance-misplaced-failure-en" xml:lang="en">
      AAP section (appraisal) found in metadataMaintenance but not in identificationInfo. The AAP section in metadataMaintenance is never read; it must be declared under identificationInfo/resourceMaintenance.
    </sch:diagnostic>
    <sch:diagnostic id="rule.che.aap-metadatamaintenance-misplaced-failure-fr" xml:lang="fr">
      Section AAP (appraisal) trouvée dans metadataMaintenance mais absente de identificationInfo. La section AAP dans metadataMaintenance n'est jamais lue ; elle doit être déclarée sous identificationInfo/resourceMaintenance.
    </sch:diagnostic>
    <sch:diagnostic id="rule.che.aap-metadatamaintenance-misplaced-failure-de" xml:lang="de">
      AAP-Bereich (appraisal) in metadataMaintenance gefunden, aber nicht in identificationInfo. Der AAP-Bereich in metadataMaintenance wird nie gelesen; er muss unter identificationInfo/resourceMaintenance deklariert werden.
    </sch:diagnostic>
  ...
  <sch:pattern id="rule.che.aap-metadatamaintenance-misplaced">
    <sch:title xml:lang="en">AAP section in metadataMaintenance requires AAP section in identificationInfo (metadataMaintenance is never read)</sch:title>
    <sch:title xml:lang="fr">Section AAP dans metadataMaintenance implique une section AAP dans identificationInfo (metadataMaintenance n'est jamais lu)</sch:title>
    <sch:title xml:lang="de">AAP-Bereich in metadataMaintenance erfordert AAP-Bereich in identificationInfo (metadataMaintenance wird nie gelesen)</sch:title>
