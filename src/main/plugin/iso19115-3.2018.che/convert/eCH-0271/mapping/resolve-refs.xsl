...
<!--
  ...
  Input:  Raw GM03 INTERLIS transfer file (eCH0271_1:TRANSFER/eCH0271_1:DATASECTION)
...
<xsl:stylesheet version="1.0"
  ...
  <!-- ================================================================
       ...
       ================================================================ -->
  <xsl:template match="eCH0271_1:GM03_2_1Comprehensive.Comprehensive|eCH0271_1:GM03_2_1Core.Core" mode="ResolveRefs">
    <xsl:element name="{local-name(.)}" namespace="{namespace-uri(.)}">
      <!-- Prefer MD_Metadata with parentIdentifier (if it's a child metadata).
           Otherwise, take the first one. -->
      <xsl:choose>
        <xsl:when test="eCH0271_1:GM03_2_1Core.Core.MD_Metadata[eCH0271_1:parentIdentifier/@REF]">
          <xsl:apply-templates select="eCH0271_1:GM03_2_1Core.Core.MD_Metadata[eCH0271_1:parentIdentifier/@REF][1]" mode="ResolveRefs">
            <xsl:with-param name="parent" select="name(.)"/>
          </xsl:apply-templates>
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates select="eCH0271_1:GM03_2_1Core.Core.MD_Metadata[1]" mode="ResolveRefs">
            <xsl:with-param name="parent" select="name(.)"/>
          </xsl:apply-templates>
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:apply-templates select="eCH0271_1:GM03_2_1Comprehensive.Comprehensive.formatDistributordistributorFormat"
  ...
  <!-- ================================================================
       ...
       ================================================================ -->
  <xsl:template match="eCH0271_1:GM03_2_1Comprehensive.Comprehensive.formatDistributordistributorFormat" mode="ResolveRefs"/>
  ...
  <xsl:template match="*" mode="ResolveRefs">
    ...
    <xsl:element name="{local-name(.)}" namespace="{namespace-uri(.)}">
      ...
      <xsl:if test="@TID">
        ...
        <xsl:for-each select="/eCH0271_1:TRANSFER/eCH0271_1:DATASECTION/eCH0271_1:GM03_2_1Comprehensive.Comprehensive/*|/eCH0271_1:TRANSFER/eCH0271_1:DATASECTION/eCH0271_1:GM03_2_1Core.Core/*">
        ...
        <xsl:if test="ends-with($selfName, 'Comprehensive.Comprehensive.LI_Source')">
          <xsl:apply-templates mode="ResolveRefs" select="/eCH0271_1:TRANSFER/eCH0271_1:DATASECTION/eCH0271_1:GM03_2_1Comprehensive.Comprehensive/
                       eCH0271_1:GM03_2_1Comprehensive.Comprehensive.sourceStepsource[eCH0271_1:source/@REF = $myTID]/eCH0271_1:sourceStep" />
        </xsl:if>
      </xsl:if>
    </xsl:element>
  </xsl:template>
    ...
    <xsl:key name="index" match="/eCH0271_1:TRANSFER/eCH0271_1:DATASECTION/eCH0271_1:GM03_2_1Comprehensive.Comprehensive//*|/eCH0271_1:TRANSFER/eCH0271_1:DATASECTION/eCH0271_1:GM03_2_1Core.Core//*" use="@TID"/>
  ...
  <xsl:template match="eCH0271_1:formatDistributor/@REF" mode="ResolveRefsCopy">
    <xsl:apply-templates mode="ResolveRefs" select="."/>
  </xsl:template>

  <xsl:template match="eCH0271_1:distributorFormat/@REF" mode="ResolveRefsCopy">
    <xsl:apply-templates mode="ResolveRefs" select="."/>
  </xsl:template>
